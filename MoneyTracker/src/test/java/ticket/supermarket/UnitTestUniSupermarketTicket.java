...
public class UnitTestUniSupermarketTicket {
    @Test
    public void t_constructor_var_2_params()
    {
        ...
        ITicket ticket = new UniSupermarketTicket(payerId, debts);
    ...
    public void t_constructor_var_3_params()
    {
        ...
        ITicket ticket = new UniSupermarketTicket(payerId, debts, text);
